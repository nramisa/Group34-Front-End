...
$sql = "SELECT `business_owner`.`OwnerID`, `business_owner`.`FirstName`, `business_owner`.`LastName`, `business_owner`.`Sex`, `ownedbusiness`.`BusinessID`
        FROM `business_owner`
        RIGHT JOIN `ownedbusiness` ON `business_owner`.`OwnerID` = `ownedbusiness`.`OwnerID`";
...
<head>
    ...
    <title>Investor & Government Rep | Business Owners</title>
