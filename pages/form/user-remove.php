...
include "../../database.php";
  ...
  if (isset($_POST['RemoveUser'])) {
    $remove_user_ID = $_POST['RemoveUserID'];
    $sql_remove = "DELETE FROM `end_user` WHERE `UserID`='$remove_user_ID'";
    $result_remove = $conn->query($sql_remove);

    if ($result_remove == TRUE) {
        echo "Record deleted successfully!";
        header("refresh:2; url=../tables/users-data.php");
    } else {
...
<meta charset="utf-8">
  ...
  <title>Administrator | Remove Users</title>
      ...
      <div class="col-md-6">
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Remove User from Table</h3>
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="inputRemoveUserID">User ID</label>
                        <input type="text" name="RemoveUserID" id="inputRemoveUserID" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="submit" name="RemoveUser" value="Remove" class="btn btn-danger">
                    </div>
                </form>
            </div>
        </div>
