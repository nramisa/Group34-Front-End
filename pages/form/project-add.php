...
if (isset($_POST['AddBusiness'])) {
    ...
    $sql = "INSERT INTO `business`(`BusinessID`,`BusinessName`, `WebsiteLink`, `BusinessType`) VALUES ('$business_ID','$business_name','$website','$business_type')";
    $result = $conn->query($sql);
    $sql = "INSERT INTO `business_industry`(`BusinessID`,`Industry`) VALUES ('$business_ID','$industry')";
    $result = $conn->query($sql);
    $sql = "INSERT INTO `business_supplier`(`BusinessID`,`SupplierID`) VALUES ('$business_ID','$supplier')";
    $result = $conn->query($sql);
    $sql = "INSERT INTO `business_basedin`(`BusinessID`,`City`,`Country`,`Zip`) VALUES ('$business_ID','$city','$country','$zip')";
    $result = $conn->query($sql);
...
<meta charset="utf-8">
  ...
  <title>Administrator | Add Businesses</title>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="" method="POST">
                 ...
                 <div class="form-group">
                   <input type="submit" name="AddBusiness" value="Add Business" class="btn btn-success">
                 </div>
              </form>
            </div>
          </div>
