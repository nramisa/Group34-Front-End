...
$sql = "SELECT UserID, FirstName, LastName, PhoneNo, Email, Password, City, Zip, Country, Sex, DOB, `Consumer?`, `Investor?`, `GovernmentRep?` FROM end_user";
...
<head>
  ...
  <title>Administrator | User Table</title>
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      ?>
                              ...
                              <td><?php echo $row['GovernmentRep?']; ?></td>
                              </tr>                       
